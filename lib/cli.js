...
function parseArgs(argv) {
    const options = { mode: 'time', numbers: [], json: false, help: false };
    const positionals = [];
    let i = 0;
    while (i < argv.length) {
        const arg = argv[i];
